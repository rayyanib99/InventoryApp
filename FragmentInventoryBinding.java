...
public final class FragmentInventoryBinding implements ViewBinding {
  ...
  private FragmentInventoryBinding(@NonNull ConstraintLayout rootView,
      @NonNull LinearLayout linearLayoutItems) {
  ...
  public static FragmentInventoryBinding bind(@NonNull View rootView) {
    ...
    int id;
    missingId: {
      id = R.id.linear_layout_items;
      LinearLayout linearLayoutItems = ViewBindings.findChildViewById(rootView, id);
      if (linearLayoutItems == null) {
        break missingId;
      }

      return new FragmentInventoryBinding((ConstraintLayout) rootView, linearLayoutItems);
    }
